...
import org.ovi.databinding.FragmentRegFosterCareBinding
...
class RegFosterCareFragment : BaseFragment<FragmentRegFosterCareBinding>() {
    ...
    override fun getViewBinding() = FragmentRegFosterCareBinding.inflate(layoutInflater)
    ...
    override fun onFragmentCreated() {
        ...
        with(binding.include) {
            tvTitle.text =
                getString(R.string.are_you_participating_in_one_of_the_following_independent_living_programs_extended_foster_care_efc_postsecondary_education_services_and_support_pess_or_aftercare_services)
            tvText.text =
    ...
    private fun callback(choice_id: Int?, text_value: String) {
        val answer = AnswersItem(text_value = text_value, choice_id = choice_id, question_id = 10)
